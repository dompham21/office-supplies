...
public class BuyHistoryMonthFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setControl();
        setEvent();
        reportViewModel.getBuyHistory(App.getAuthorization(), 1);
    ...
    private void setEvent() {
        reportViewModel.getBuyHistoryData().observe(getViewLifecycleOwner(), object -> {
            ...
            if (result == 1 && object.getData() != null) {
                ...
                cartesian.title("Thống kê chi tiêu 30 ngày gần nhất");
